...
const seriousQuotes = [
	...
	["images/headquotes/hq-twok-1.webp","A bloodied Khan","From hell's heart, I stab at thee. For hate's sake, I spit my last breath... at thee.","Khan Noonien Singh","films/ii-twok.html","<em>Star Trek II: The Wrath of Khan</em>"],
	
	["images/headquotes/hq-ent-1x01.webp","Numerous spectators viewing a video recording of Zefram Cochrane speaking","Imagine it. Thousands of inhabited planets at our fingertips, and we'll be able to explore those strange new worlds and seek out new life and new civilizations. This engine will let us go boldly where no man has gone before.","Zefram Cochrane","ent/ent-s1.html#e01","ENT 1x01: Broken Bow"],
	
	["images/headquotes/hq-ds9-2x05.webp","Garak having a conversation with Bashir over a cup of coffee","Truth, Doctor, is in the eye of the beholder. I never tell the truth because I don't believe there is such a thing. That's why I prefer the straight line simplicity of cutting cloth.","Garak","ds9/ds9-s2.html#e05","DS9 2x05: Cardassians"],
	
	["images/headquotes/hq-tng-2x09.webp","Picard and Guinan having a discussion in Ten Forward","Consider that in the history of many worlds there have always been disposable creatures. They do the dirty work. They do the work that no one else wants to do because it's too difficult, or too hazardous. And an army of Datas, all disposable... you don't have to think about their welfare, you don't think about how they feel. Whole generations of disposable people.","Guinan","tng/tng-s2.html#e09","TNG 2x09: The Measure of a Man"],
	
	["images/headquotes/hq-tos-1x10.webp","Kirk looking pensive as Spock taps controls in the background on the bridge","There's no such thing as the unknown, only things temporarily hidden, temporarily not understood.","Captain James T. Kirk","tos/tos-s1.html#e10","TOS 1x10: The Corbomite Maneuver"],
	
	["images/headquotes/hq-pic-2x04.webp","Guinan, crying","This place is a pressure cooker. You know they’re actually killing the planet? Truth is whatever you want it to be; facts aren’t even facts anymore. A few folks have enough resources to fix all the problems for the rest, but they won’t &ndash; because their greatest fear is having less. They got one tiny ball in the entire galaxy, and all this species wants to do is fight.","Guinan","pic/pic-s2.html#e04","PIC 2x04: Watcher"],
	
	["images/headquotes/hq-tng-2x16.webp","Q speaking to Picard on the bridge","If you can't take a little bloody nose, maybe you ought to go back home and crawl under your bed. It's not safe out here. It's wondrous, with treasures to satiate desires both subtle and gross, but it's not for the timid.","<span class='Q'>Q</span>","tng/tng-s2.html#e16","TNG 2x16: Q Who"],
	
	["images/headquotes/hq-voy-5x15.webp","Captain Janeway crouching slightly to speak with young Naomi Wildman","There are three things to remember about being a starship captain: keep your shirt tucked in, go down with the ship, and never abandon a member of your crew.","Captain Kathryn Janeway","voy/voy-s5.html#e15","VOY 5x15/16: Dark Frontier"],
	
	["images/headquotes/hq-pic-2x05.webp","Q speaking with Adam Soong at a booth in a diner","I am the evolution of stardust. I'm the gentle flutter of a butterfly. I am Death, destroyer of worlds. And I'm also a big fan of your work!","<span class='Q'>Q</span>","pic/pic-s2.html#e05","PIC 2x05: Fly Me to the Moon"],
	
	["images/headquotes/hq-gen-1.webp","Picard and Riker conversing on the bridge of the Enterprise","I rather believe that time is a companion who goes with us on the journey, and reminds us to cherish every moment, because they'll never come again.","Captain Jean-Luc Picard","films/generations.html","<em>Star Trek Generations</em>"],
	
	["images/headquotes/hq-ds9-6x19.webp","Captain Sisko performing a soliloquy directly into the camera","My father used to say that the road to Hell is paved with good intentions. I laid the first stone right there. I'd committed myself. I'd pay any price, go to any lengths, because my cause was righteous. My... intentions were good. In the beginning, that seemed like enough.","Captain Benjamin Sisko","ds9/ds9-s6.html#e19","DS9 6x19: In the Pale Moonlight"],
	
	["images/headquotes/hq-tng-3x16.webp","Captain Picard in the Observation Lounge","There are times, sir, when men of good conscience cannot blindly follow orders. You acknowledge their sentience, but you ignore their personal liberties and freedom. Order a man to hand his child over to the state? Not while I am his captain.","Captain Jean-Luc Picard","tng/tng-s3.html#e16","TNG 3x16: The Offspring"],
	
	["images/headquotes/hq-tuc-1.webp","Spock regarding Valeris in the reflection of his mirror","Logic is the beginning of wisdom, not the end.","Spock","films/vi-tuc.html","<em>Star Trek VI: The Undiscovered Country</em>"],
	
	["images/headquotes/hq-pic-2x09.webp","Tallinn speaking with Picard in the solarium","Love can be a source of great grief and immense pain, of tremendous guilt, a reason to run from ourselves or away from each other. Love can be a curse, but always and completely... it's a gift.","Tallinn","pic/pic-s2.html#e09","PIC 2x09: Hide and Seek"],
	
	["images/headquotes/hq-tng-4x21.webp","Captain Picard and Lieutenant Worf looking through the observation room windows on the Enterprise-D","Villains who twirl their mustaches are easy to spot; those who clothe themselves in good deeds are well-camouflaged. ...Someone like [that] will always be with us, waiting for the right climate in which to flourish, spreading fear in the name of righteousness. Vigilance, Mister Worf, that is the price we have to continually pay.","Captain Jean-Luc Picard","tng/tng-s4.html#e21","TNG 4x21: The Drumhead"]
]

const comedicQuotes = [

	["images/headquotes/hq-tng-1x03.webp","A drunken Data looking quizzically at Picard","If you prick me, do I not... leak?","Data","tng/tng-s1.html#e03","TNG 1x03: The Naked Now"],
	
	["images/headquotes/hq-ds9-3x03.webp","Grilka and Quark laughing together","I really am very grateful for all you have done, Quark. That is why I'm going to let you take your hand off my thigh, instead of shattering every bone in your body.","Grilka","ds9/ds9-s3.html#e03","DS9 3x03: The House of Quark"],
	...
	["images/headquotes/hq-voy-1x16.webp","Neelix, Torres, and Tuvok examining a lump of cheese sealed in a clear container","Get the cheese to sickbay.","B'Elanna Torres","voy/voy-s1.html#e16","VOY 1x16: Learning Curve"],
	
	["images/headquotes/hq-pic-1x02.webp","Jurati and Picard, in his study","I never cared for science fiction. I guess I just didn't get it.","Jean-Luc Picard","pic/pic-s1.html#e02","PIC 1x02: Maps and Legends"],
	
	["images/headquotes/hq-tng-4x20.webp","Worf, dressed as Will Scarlet, looking angry","Sir, I protest! I am not a merry man!","Worf","tng/tng-s4.html#e20","TNG 4x20: Qpid"],
	
	["images/headquotes/hq-ds9-1x18.webp","Dax enjoying a colorful drink as Kira looks confused","You know what they say &ndash; put the shoe on the right foot first, but put the left foot first into the bathtub.","Jadzia Dax","ds9/ds9-s1.html#e18","DS9 1x18: Dramatis Personae"],
	
	["images/headquotes/hq-voy-6x18.webp","Seven of Nine in the mess hall","Fun will now commence.","Seven of Nine","voy/voy-s6.html#e18","VOY 6x18: Ashes to Ashes"],
	
	["images/headquotes/hq-tng-5x23.webp","The Borg drone known as Hugh","We are Hugh.","Hugh","tng/tng-s5.html#e23","TNG 5x23: I Borg"],
	
	["images/headquotes/hq-voy-6x24.webp","The Doctor and Lewis Zimmerman being distracted by a talking iguana","Computer, deactivate iguana.","The Doctor","voy/voy-s6.html#e24","VOY 6x24: Life Line"],
	
	["images/headquotes/hq-ds9-5x25.webp","Jake Sisko making an impassioned plea","The entire future of the galaxy may depend on us tracking down Willie Mays and stopping him.","Jake Sisko","ds9/ds9-s5.html#e25","DS9 5x25: In the Cards"],
	
	["images/headquotes/hq-pic-3x03.webp","Worf returning a weapon to Raffi","I am Worf, son of Mogh, House of Martok, son of Sergey, House of Rozhenko, bane to the Duras family, slayer of Gowron. I have made some chamomile tea. Do you take sugar?","Worf","pic/pic-s3.html#e03","PIC 3x03: Seventeen Seconds"],
	
	["images/headquotes/hq-fc-2.webp","A drunken Troi speaking to Riker","<strong>Timeline</strong>?! This is no <strong>time</strong> to argue about <strong>time</strong>... we don't... have... the <strong>time</strong>!","Deanna Troi","films/firstcontact.html","<em>Star Trek: First Contact</em>"]
